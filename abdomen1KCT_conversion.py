...
if __name__ == "__main__":
    ...
    task_name = "Task601_abdomen1KCT_subtask2"
    downloaded_data_dir = "/media/me/dataset/FullySupervised/Subtask2/"
    ...
    cur = join(downloaded_data_dir, 'TrainMask')
    for p in subfiles(cur, join=False):
        ...
        seg = patfile
        # seg = join(patfile, p + "_seg.nii.gz")
    ...
    cur = join(downloaded_data_dir, 'TrainImage')
    for p in subfiles(cur, join=False):
        patfile = join(cur, p)
        patient_name = p
        # patient_names.append(patient_name)
        ...
        shutil.copy(ct, join(target_imagesTr, patient_name))



    json_dict = OrderedDict()
    json_dict['name'] = "abdomen1KCT"
    json_dict['description'] = "nothing"
    json_dict['tensorImageSize'] = "4D"
    json_dict['reference'] = "see abdomen1KCT"
    json_dict['licence'] = "see abdomen1KCT license"
    ...
    # downloaded_data_dir = "/home/user062/MICCAI_BraTS_2019_Data_Validation/"
